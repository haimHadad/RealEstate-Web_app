    ...
    public class AccountController : Controller
    {
        ...
        public async Task<double> getAccountBalanceFromBlockChainAsync(Account myAccount , String AccountAddress)
        {
            if(AccountAddress == null || myAccount == null)
                return -1;
            var acount = new Nethereum.Web3.Accounts.Account("8a24eeca6f3d9fc95b27b187c7240ae9b279ed73484fba3e486fcb4afc463121");
            var myWeb3 = new Web3((Nethereum.Web3.Accounts.Account)myAccount, myAccount.AccountNetwork + "" + myAccount.InfuraApiKey);
